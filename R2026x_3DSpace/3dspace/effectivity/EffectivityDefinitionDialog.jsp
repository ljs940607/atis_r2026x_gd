...
com.dassault_systemes.plm.config.entity.itf.IConfiguredEntity,
com.dassault_systemes.plm.config.entity.itf.IConfiguredEntity.InternalRevisionMode,
...
try {
    ...
    */
    ...
    if (strmode!=null && (strmode.equals("structureEdit") || strmode.equals("edit") ||  strInvockedFrom.equalsIgnoreCase("fromTable")))
    {
        ...
        {
           // JDV Test IR 1445296 checking the revision mode of the reference
           // The exception has to be thrown outside the next try / catch
           boolean referenceIsValidated = true;
       	try
         {
          ...
          IConfiguredEntity parentReference = instanceToConfigure.getParentReference( context );
          if (( parentReference.getInternalRevisionMode() == InternalRevisionMode.EXPLICIT_VARIANT ) || ( parentReference.getInternalRevisionMode() == InternalRevisionMode.EFF_BASED ))
          {
      ...
      {
            throw new Exception( "Blocked operation, the parent reference is in explicit + variant or effectivity based revision mode" );
      }
