...
<%
        ...
        else if(strMode.equalsIgnoreCase("delete"))
        {
            ...
            String sProductsObsoleteState = "Obsolete";
            ...
            if(lstPRDChildTypes.contains((String) productMap.get(DomainConstants.SELECT_TYPE)) && sProductsObsoleteState.equals((String) productMap.get(DomainConstants.SELECT_CURRENT))){
