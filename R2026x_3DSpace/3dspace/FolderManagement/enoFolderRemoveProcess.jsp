...
if(slTableRowIdList.contains("0")){
	...
	slWorkspaceVaultList = new StringList();
	slDocumentList = new StringList();
	for(int i=0;i<strRowIds.length;i++){
	    DomainObject selObject = new DomainObject(strRowIds[i]);
	    if(selObject.getInfo(context, DomainObject.SELECT_TYPE).equals(typeProjectVault)){
                    ...
                    <% 
                      ...
                      e.printStackTrace();	
                		...
                		for(int i=0;i<emxTableRowId.length;i++){
	    					...
	    					if(!objWorkspaceVault.getInfo(context, DomainObject.SELECT_TYPE).equals(typeProjectVault)){
