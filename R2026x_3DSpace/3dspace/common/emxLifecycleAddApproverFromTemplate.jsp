...
function routeTemplateChooser_onclick(strFieldHiddenName, strFieldDisplayName, strFieldHiddenObjId) {
     ...
     var  strURL ="../common/emxFullSearch.jsp?field=TYPES=type_RouteTemplate:CURRENT=policy_RouteTemplate.state_Active:ROUTE_COMPLETION_ACTION=Notify Route Owner:LATESTREVISION=TRUE:LINK_TEMPLATE=FALSE:CHOICE_TEMPLATE!=TRUE&table=RouteTemplateSummary&showInitialResults=true&formInclusionList=ROUTE_TEMPLATE_AVAILABILITY_TYPE&form=BPSRouteTemplateSearch&submitURL=../common/AEFSearchUtil.jsp&selection=single&fieldNameActual="+strFieldHiddenObjId+"&fieldNameDisplay="+strFieldDisplayName;
