...
<%
  ...
  //HLN4: simulation mode
  String MAPKEY_SIMUL = emxGetParameter(request,VPLMIntegrationConstants.MAPKEY_SIMUL);
  ...
  boolean simulAllowed = MDCollabIntegrationUtilities.simulCollabActivated(context);
  if(simulAllowed && MAPKEY_SIMUL!= null && MAPKEY_SIMUL.equals("SIMUL_COLLAB")){
  fs.createFooterLink("emxVPLMSynchro.Button.Execute",
