...
<%
   ...
   String MatrixINISettings = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), "emxFramework.SystemData.CurrentMatrixINISettings"); 
     ...
     UpgradeValidArray[0] = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), "emxFramework.SystemData.MatrixUpgradeValidation");
     UpgradeValidArray[1] = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), "emxFramework.SystemData.Administrationtables");
     UpgradeValidArray[2] = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), "emxFramework.SystemData.Tablesforvaultsandstores");
...
%>
    ...
    <%
        ...
        for (Enumeration e = systemData.keys() ; e.hasMoreElements() ;)
        {
            ...
            String keyStr = "emxFramework.SystemData."+replace(mainKey);
            optionKey = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), keyStr);
            if(optionKey.equals(keyStr)) optionKey = mainKey;
    ...
    <%
       ...
       String internationalizedKey = "";
        ...
        for (Enumeration e1 = systemData.keys() ; e1.hasMoreElements() ;)
        {
           ...
           String keyStr = "emxFramework.SystemData."+replace(mainKey);
           headingKey = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), keyStr);
           if(headingKey.equals(keyStr)) headingKey = mainKey;
    ...
    <%
         if(!mainKey.equals(UpgradeValidArray[0])){
           ...
           for (Enumeration e2 = keyList.elements() ; e2.hasMoreElements() ;)
           {
             ...
             keyStr = "emxFramework.SystemData."+replace(Key);
             internationalizedKey = EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), keyStr);
             if(internationalizedKey.equals(keyStr)) internationalizedKey = Key;
    %>
        <tr>
          <!-- //XSSOK -->
