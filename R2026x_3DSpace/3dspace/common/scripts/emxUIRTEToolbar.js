...
<p class="submit"><button id="ok">Ok</button><button id="cancel">Cancel</button></p>'
	...
	$('#rgb').on('mousemove', function(e) { if(mouse_down && mouse_over) compute_color(this, true, false, false, e); return false;} );
	$('#gray').on('mousemove', function(e) { if(mouse_down && mouse_over) compute_color(this, false, true, false, e); return false;} );
	$('#palette').on('mousemove', function(e) { if(mouse_down && mouse_over) compute_color(this, false, false, true, e); return false;} );
	$('#rgb').on('click', function(e) { compute_color(this, true, false, false, e); return false;} );
	$('#gray').on('click', function(e) { compute_color(this, false, true, false, e); return false;} );
	$('#palette').on('click', function(e) { compute_color(this, false, false, true, e); return false;} );

	$('#cancel', panel).on('click', function() { panel.remove(); return false; } );
	$('#ok', panel).on('click', 
		function() {
...
function lwrte_special_character(){
	...
	$(':button', '#specialCharactersPanel', panel).on('click', 
			function() {
	...
	$(self.iframe_doc).on('click',function(e){
