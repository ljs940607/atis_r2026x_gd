...
define('emxUIStructureFancyTree',
    ['jQuery'], function (jQuery) { 
        ...
        function drawTreeBar(strucData) {
        	...
        	jQuery("#treeBar").append("<select id='treeBarSelect'>").on( "change",reLoadStructureTree);
	                ...
	                jQuery(jQDivId).fancytree({
	                    ...
	                    lazyLoad: function (event, data) {
	                        ...
	                        data.result = jQuery.ajax({
								...
								function(d){setTimeout(function(){node.makeVisible({scrollIntoView: false}); }, 500)}
							);
	                    },
