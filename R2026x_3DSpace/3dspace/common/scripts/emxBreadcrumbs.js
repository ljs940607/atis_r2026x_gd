        ...
        goBack: function(){
			...
			if(typeof getTopWindow().jQuery("#navBar") != 'undefined'){
        		...
        		if(bc.appInfo != null && typeof bc.appInfo != 'undefined' && bc.appInfo.appTrigram != appName){
        			...
        			var appInfoJSONObj={
						brandName: bc.appInfo.brandName,
						appName: bc.appInfo.appName,
						appTrigram: bc.appInfo.appTrigram,
						appMenuList: bc.appInfo.appMenuList,
						licensedAppList: bc.appInfo.licensedAppList
					}
