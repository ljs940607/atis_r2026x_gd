...
$(document).ready(function() {
	...
	$("td.counterCell").on("mouseenter", function() { $(this).find(".counterText").addClass("counterTextHighlight");    });
	$("td.counterCell").on("mouseleave", function() {	$(this).find(".counterText").removeClass("counterTextHighlight"); });
...
function resizeTable() {
	var widthLeft = $(window).width() - ($("#middle").width() || 0) - ($("#right").width() || 0) - 1;
...
function openURLInDetails(url) {
	...
	if (!$("#details").is(':visible')) {
	  var widthDetails = $(window).width() - ($("#middle").width() || 0) - ($("#right").width() || 0) - 1;
