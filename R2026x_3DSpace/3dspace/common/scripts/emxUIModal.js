...
function showModalDialog(strURL, intWidth, intHeight, bScrollbars, strPopupSize,searchDim, applyIEMask) {
	    ...
	    if(searchDim){
	    	var topPosition = jQuery('#pageHeadDiv').height() || 0;
...
function adjustSearchLeftPanelLayout(objWin){
	...
	var optionsHeight = objWin.jQuery("#searchOptions").height() || 0;
	var headHeight = objWin.jQuery("#searchHead").height() || 0;
	var topValue = optionsHeight + headHeight;

	objWin.jQuery("#searchBody").css("top", topValue + "px");
