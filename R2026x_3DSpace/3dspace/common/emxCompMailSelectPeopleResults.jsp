...
<% 
  ...
  if(sLastName.contains("&&")||sLastName.contains("||")||sFirstName.contains("&&")||sFirstName.contains("||")){
		return;
  }
  ...
  if(PersonUtil.isPersonObjectSchemaExist(context))
  {
    ...
    if(isEntireDatabase) {
	   ...
	   try {
		   ...
		   throw new FrameworkException(EnoviaResourceBundle.getProperty(context,"emxFrameworkStringResource", locale, "emxFramework.ServerError.Message"));
	   }
	 }
  }
  else
