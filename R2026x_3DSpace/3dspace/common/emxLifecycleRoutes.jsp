...
<%
  ...
  try {
    ...
    String sRouteTargetStateAttr = PropertyUtil.getSchemaProperty(context, "attribute_RouteTargetState");
    ...
    String sObjectRouteTargetState = null;
    String absolutePolicyName = null;
    String absoluteStateName = null;
    String absoluteTargetStateName = null;
    String objType = null;
    ...
    selectObjectRouteRelStmts.addAttribute(sRouteTargetStateAttr);
    String sTypeWhere="(islast == TRUE)"; 
    routeSelect = busObject.expandSelect(context, relPattern.getPattern(), typePattern.getPattern(), selectRouteStmts,
                                                selectObjectRouteRelStmts, true, true, (short)1,sTypeWhere,null);
    ...
    while (relObjectRouteItr.next()) {
      // if the relationship is "Object Route" then get the routes.      
        ...
        sObjectRouteTargetState = (String)objectRouteRelAttributes.get("attribute[" + sRouteTargetStateAttr + "]");
        ...
        if ((sObjectRouteBaseState!=null && (!sObjectRouteBaseState.equalsIgnoreCase("null"))&& sObjectRouteBaseState.equals(sAdHoc)) || objType.equals(typeWorkflow)) {
          ...
          absoluteTargetStateName = FrameworkUtil.lookupStateName(context, absolutePolicyName, sObjectRouteTargetState);
        }
        ...
        if (absoluteStateName!= null && absoluteStateName.equals(sFromStateName) && (UIUtil.isNullOrEmpty(absoluteTargetStateName) || absoluteTargetStateName.equals(sToStateName))) {
...
<td width="1%"><img src="images/utilSpacer.gif" width="1" height="28" alt="" /></td>
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="3" class="list">
      <tr>
         ...
         <th align="left"><emxUtil:i18n localize="i18nId">emxFramework.Common.Rev</emxUtil:i18n></th>
  ...
  <%
    ...
    strList.addElement(DomainObject.SELECT_REVISION);
    ...
    while (enumRouteIds.hasMoreElements()) {
      ...
      String sRouteRevision = (String) map.get(DomainObject.SELECT_REVISION);
...
%>
        ...
        <td align="left"><%=sRouteRevision%></td>
