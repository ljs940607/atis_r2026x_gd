...
for(int i=0;i<emxTableRowId.length;i++) {
    ...
    strList.addElement("type.kindof["+ DomainConstants.TYPE_PROJECT_SPACE +"]");
    strList.addElement("type.kindof["+ DomainConstants.TYPE_PROJECT_TEMPLATE +"]");
    strList.addElement("type.kindof["+ DomainConstants.TYPE_PROGRAM +"]");
    strList.addElement("type.kindof["+ DomainConstants.TYPE_PROJECT_CONCEPT +"]");
    ...
    String isProjectSpace = (String)resultList.get("type.kindof["+ DomainConstants.TYPE_PROJECT_SPACE +"]");
    String isProjectTemplate = (String)resultList.get("type.kindof["+ DomainConstants.TYPE_PROJECT_TEMPLATE +"]");
    String isProgram = (String)resultList.get("type.kindof["+ DomainConstants.TYPE_PROGRAM +"]");
    String isProjectConcept = (String)resultList.get("type.kindof["+ DomainConstants.TYPE_PROJECT_CONCEPT +"]");
    ...
    if(!UIUtil.isNullOrEmpty(strTypeSymbolicName) && "type_Person".equals(strTypeSymbolicName)) {
        displayValue.append(PersonUtil.getFullName(context, strContextObjectName));
    		...
    		|| ("type_Group".equals(strTypeSymbolicName) || "type_GroupProxy".equals(strTypeSymbolicName)) || "true".equalsIgnoreCase(isProjectSpace) || "true".equalsIgnoreCase(isProjectTemplate) || "true".equalsIgnoreCase(isProgram) || "true".equalsIgnoreCase(isProjectConcept)) {
