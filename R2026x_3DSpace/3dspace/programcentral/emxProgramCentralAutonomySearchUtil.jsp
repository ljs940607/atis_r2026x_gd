	...
	try
{
  ...
  else
  {
      ...
      busSelects.add(ProgramCentralConstants.SELECT_KINDOF_PROJECT_CONCEPT);
	  ...
	  MapList mlTaskAssigneeInfo = (MapList)DomainObject.getInfo(context,new String[]{(String)splitObject.get(0)}, busSelects);
	  Map resultMap = (Map) mlTaskAssigneeInfo.get(0);
	  if ("true".equalsIgnoreCase((String)resultMap.get(ProgramCentralConstants.SELECT_KINDOF_PROJECT_SPACE)) || "true".equalsIgnoreCase((String)resultMap.get(ProgramCentralConstants.SELECT_KINDOF_PROJECT_CONCEPT))  || "true".equalsIgnoreCase((String)resultMap.get(ProgramCentralConstants.SELECT_IS_PROJECT_TEMPLATE)) || "true".equalsIgnoreCase((String)resultMap.get(ProgramCentralConstants.SELECT_IS_PROGRAM))){
		  if(ProgramCentralUtil.isNotNullString((String)resultMap.get(DomainConstants.SELECT_ATTRIBUTE_TITLE))){
		  strObjname = (String)resultMap.get(DomainConstants.SELECT_ATTRIBUTE_TITLE);
		  }
	  }
