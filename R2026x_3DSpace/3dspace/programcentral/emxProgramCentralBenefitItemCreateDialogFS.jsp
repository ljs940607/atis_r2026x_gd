...
<%
  ...
  if("true".equalsIgnoreCase(cleanSession)){
    session.removeAttribute("selectedBenefitCategories");
    session.removeAttribute("benefitNames");
    session.removeAttribute("CreateFinancialParameters");
  }
  ...
  session.setAttribute("CreateFinancialParameters", createParams);
...
// Specify URL to come in middle of frameset
  ...
  if(selectedBenefitCategories != null) {
    session.setAttribute("selectedBenefitCategories", selectedBenefitCategories);
  }
