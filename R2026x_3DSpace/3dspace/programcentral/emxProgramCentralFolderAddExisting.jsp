     ...
     <%
         ...
         //Added 29-June-2010:rg6:IR-054295   
          ...
          //End 29-June-2010:rg6:IR-054295
			...
			if("TRUE".equalsIgnoreCase(isTaskType) || (("TRUE".equalsIgnoreCase(isProjectTemplate) || "TRUE".equalsIgnoreCase(isProjectConcept) || "TRUE".equalsIgnoreCase(isProjectSpace) || "true".equalsIgnoreCase(isChecklist)) && "referenceDocument".equalsIgnoreCase(mode))){
						 session.setAttribute("needFullPageRefresh", "true");
			}
