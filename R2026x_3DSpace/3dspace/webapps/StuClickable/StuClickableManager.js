define('DS/StuClickable/StuClickableManager', ['DS/StuCore/StuContext', 'DS/StuCore/StuManager', 'DS/EPTaskPlayer/EPTask', 'DS/EPTaskPlayer/EPTaskPlayer', 'DS/EPEventServices/EPEvent',
    ...
    'DS/StuClickable/StuSpatialTapEvent',
...
], function (STU, Manager, Task, TaskPlayer, EPEvent) {
	'use strict';
	...
	*/
	...
	ClickableManager.prototype.onInitialize = function () {
        ...
        this.spatialTapCb = STU.makeListener(this, 'onSpatialTap');
        eventServices.addListener(STU.SpatialTapEvent, this.spatialTapCb);

		this.spatialDoubleTapCb = STU.makeListener(this, 'onSpatialDoubleTap');
        eventServices.addListener(STU.SpatialDoubleTapEvent, this.spatialDoubleTapCb);
	...
	ClickableManager.prototype.onDispose = function () {
        ...
        eventServices.removeListener(STU.SpatialTapEvent, this.spatialTapCb);
        delete this.spatialTapCb;

		eventServices.removeListener(STU.SpatialDoubleTapEvent, this.spatialDoubleTapCb);
        delete this.spatialDoubleTapCb;
	...
	ClickableManager.prototype.getClickableFromPosition = function (iPosition) {
		...
		var intersections = STU.RenderManager.getInstance()._pickFromPosition(iPosition, true, false, null, true);
	...
	*/
    ...
    ClickableManager.prototype.onSpatialTap = function (iSpatialTapEvent) {
        this._sendClickableEvent(new STU.ClickablePressEvent(), new EPEvent(), iSpatialTapEvent.getActor());
    };

	ClickableManager.prototype.onSpatialDoubleTap = function (iSpatialDoubleTapEvent) {
        this._sendClickableEvent(new STU.ClickableDoubleClickEvent(), new EPEvent(), iSpatialDoubleTapEvent.getActor());
    };
