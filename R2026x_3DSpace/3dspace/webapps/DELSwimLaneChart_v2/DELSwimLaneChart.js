/// <amd-module name="DS/DELSwimLaneChart_v2/DELSwimLaneChart"/>
define("DS/DELSwimLaneChart_v2/DELSwimLaneChart", ["require", "exports", "DS/DELSwimLaneChart_v2/services/EventsHandler", "DS/DELSwimLaneChart_v2/services/DELSwimLaneChartDocument", "DS/DELSwimLaneChart_v2/model/DELSwimLaneChartModel", "DS/DELSwimLaneChart_v2/presenter/DELSwimLaneChartPresenter", "DS/DELSwimLaneChart_v2/view/DELSwimLaneChartView", "DS/Menu/ContextualMenu", "css!./assets/swimLaneChartStyles.css"], function (require, exports, EventsHandler_1, DELSwimLaneChartDocument_1, DELSwimLaneChartModel_1, DELSwimLaneChartPresenter_1, DELSwimLaneChartView_1, WUXContextualMenu) {
    "use strict";
        ...
        constructor(props = {}) {
            ...
            this._ro = new ResizeObserver((entries) => {
                window.requestAnimationFrame(() => {
                    ...
                    // your code
                    this._presenter.handleResizeObserver();
                });
            });
            this._props = props;
        ...
        attachEventsListener() {
            ...
            if (this._props.onContextMenu) {
                this._contextMenuNumber = WUXContextualMenu.addEventListener(this, {
                    callback: (params) => {
                        const target = this._presenter.getOnContextMenuTarget(params.data.target, { x: params.data.event.clientX, y: params.data.event.clientY });
                        if (this._props.onContextMenu)
    ...
    if (!window.customElements.get('swim-lane-chart-v2'))
        customElements.define('swim-lane-chart-v2', SwimLaneChart);
