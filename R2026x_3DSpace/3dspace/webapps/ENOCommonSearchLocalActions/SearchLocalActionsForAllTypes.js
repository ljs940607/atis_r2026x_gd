...
define('DS/ENOCommonSearchLocalActions/SearchLocalActionsForAllTypes',
		[ 'UWA/Class','UWA/Class/Debug', 'UWA/Class/Events', 'DS/ENOjquery/ENOjquery' ], 
		function(UWAClass, UWADebug, UWAEvents, jQuery) {
	...
	var ActionsHandler = UWAClass.singleton(UWAEvents, UWADebug, {
		...
		if((actions_data.action_id== "action_AddToClipboard")){
			...
			jQuery('#closeWidget').trigger('click');
		}	
	},
