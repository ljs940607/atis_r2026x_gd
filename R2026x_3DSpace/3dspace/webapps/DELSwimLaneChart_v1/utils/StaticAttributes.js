...
define("DS/DELSwimLaneChart_v1/utils/StaticAttributes", ["require", "exports"], function (require, exports) {
    ...
    exports.groupMargin = 6 * exports.gridStep / 4; // to avoid collision between nodes (grid-based positions) and group delimeters especially in the case of Porcedure (groupes traversing nodes)
    // node view
    exports.header_height = 1.5 * exports.gridStep;
    exports.margin = 8;
    exports.imgSize = 18;
    //icons
    exports.expand_icon = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'><path fill='#000000' d='M10,21V19H6.41L10.91,14.5L9.5,13.09L5,17.59V14H3V21H10M14.5,10.91L19,6.41V10H21V3H14V5H17.59L13.09,9.5L14.5,10.91Z'/></svg>";
