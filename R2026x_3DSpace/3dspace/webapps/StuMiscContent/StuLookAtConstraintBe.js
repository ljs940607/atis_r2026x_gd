	...
	function (STU, Behavior, UIActor3D, DSMath, Actor3D) {
		...
		LookAt.prototype.lookAt = function (iTarget) {
			...
			if (iTarget instanceof Actor3D) {
				targetPos = iTarget.getPosition("Location");
			...
			var dir = myActor.getPosition("Location");
			dir.sub(targetPos);
			dir.normalize();

			var transform = myActor.getTransform("Location");
			...
			var ZScene = this.actor.getSceneTransform("Location").matrix.getThirdColumn().normalize();
