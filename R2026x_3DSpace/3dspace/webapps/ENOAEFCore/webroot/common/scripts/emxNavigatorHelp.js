  ...
  if(htmlHelpfile=="false"){
    ...
    if(!checkURL(url)){
	  ...
	  if(emxUIConstants.HELP_URL.indexOf('http') == 0 && emxUIConstants.HELP_URL.indexOf("HelpDS.aspx") > -1){
		  ...
		  url = emxUIConstants.HELP_URL + "?P=11&V=2026x" + "&L=" +  langOnlineStr + "&F=" +htmlHelpfile + "&contextscope=" + contextscope;
		  defaultUrl = emxUIConstants.HELP_URL + "?P=11&V=2026x" + "&L=" +  langOnlineStr + "&F=" +"FrontmatterMap/DSDocHome.htm" + "&contextscope=" + contextscope;
	  }else{
