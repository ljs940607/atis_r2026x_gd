/**
 * @quickReview 23:08:25 KIE1 ZUD GVC IR-1142743-3DEXPERIENCER2023x: Unable to open Requirements widget getting error as Please log-in to this tenant in another tab
			...
			widget.addEvent('onLoad', function(){
	    		...
	    		i3DXCompassPlatformServices.getServiceUrl({
	        		...
	        		onComplete: function(data) { 
						// if data is string then initializing the baseURL with data
						if (typeof data === 'string') {
                            baseURL = data;
                        } else if (UWA.is(data, 'array')){
							// iteraring on available paltform services (data)
