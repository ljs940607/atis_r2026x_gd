        ...
        */
        var exports =  {
            ...
            init : function (serviceData) {
                ...
                jQuery(jQDivId).fancytree({
					...
					contextMenu: {
            	      ...
            	      createNode: function(event, data){
						...
						jQuery(data.node.span.parentNode).on('dragover', dragoverFromOutside);
            	        jQuery(data.node.span.parentNode).on('drop', dropFromOutside);
            	        jQuery(data.node.span.parentNode).on('dragleave', dragleave);
                		...
                		leavesOnly = jQuery("#leavesOnly").is(":checked"),
                     	match = jQuery(this).val();
                   		if(e && e.which === jQuery.ui.keyCode.ESCAPE || jQuery.trim(match) === ""){
                   			jQuery("button#btnResetSearch").trigger('click');
                   			return;
                   		}
               ...
               jQuery("button#btnResetSearch").on('click',function(e){
