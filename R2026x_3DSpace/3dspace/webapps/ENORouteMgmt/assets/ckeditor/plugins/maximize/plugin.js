...
( function() {
	...
	CKEDITOR.plugins.add( 'routecustmaximize', {
			...
			editor.addCommand( 'maximize', {
				...
				exec: function() {
					...
					var findParent = function (element) {
						if(element.$.classList.contains('cke-comments-container')){
							return element;
						} else {
					...
					if ( this.state == CKEDITOR.TRISTATE_OFF ) {
						...
						try{
							var minimizeButton = parentDiv.$.getElement('.cke_button_icon.cke_button__maximize_icon');
							minimizeButton.classList.add('wux-ui-3ds','wux-ui-3ds-2x','wux-ui-3ds-resize-fullscreen');
							minimizeButton.classList.add('wux-ui-3ds','wux-ui-3ds-2x','wux-ui-3ds-resize-fullscreen-off');
							minimizeButton.parentElement.title="Minimize";
							let commentsLabel = parentDiv.$.getElementsByClassName('comment-task-title')[0];
							let commentsLabelSeparator = parentDiv.$.getElementsByClassName('comment-task-title-separator')[0];
							if (commentsLabel && commentsLabelSeparator) {
								commentsLabel.style.display = "block";
								commentsLabelSeparator.style.display="block";
							}
						}catch(e){
						...
						try{
							var maximizeButton = parentDiv.$.getElement('.cke_button_icon.cke_button__maximize_icon');
							maximizeButton.classList.remove('wux-ui-3ds','wux-ui-3ds-2x','wux-ui-3ds-resize-fullscreen-off');
							maximizeButton.classList.add('wux-ui-3ds','wux-ui-3ds-2x','wux-ui-3ds-resize-fullscreen');
							maximizeButton.parentElement.title="Maximize";
							let commentsLabel = parentDiv.$.getElementsByClassName('comment-task-title')[0];
							let commentsLabelSeparator = parentDiv.$.getElementsByClassName('comment-task-title-separator')[0];
							if (commentsLabel && commentsLabelSeparator) {
								commentsLabel.style.display = "none";
								commentsLabelSeparator.style.display="none";
							}
						}catch(e){
