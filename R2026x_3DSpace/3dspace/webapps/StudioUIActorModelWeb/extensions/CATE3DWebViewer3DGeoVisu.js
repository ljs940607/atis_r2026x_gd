...
define('DS/StudioUIActorModelWeb/extensions/CATE3DWebViewer3DGeoVisu',
	...
	function (
		...
		let CATE3DWebViewer3DGeoVisu = CATE3DActor3DGeoVisu.extend(Listener,
			/** @lends DS/StudioUIActorModelWeb/extensions/CATE3DWebViewer3DGeoVisu.prototype **/
			{
				...
				_drawCanvasTexture: function (canvasNodeTexture, context, _tick, k) {
					...
					// let getFontIconChar = function (name) {
					// 	var span = document.createElement('span');
					// 	span.className = 'fonticon fonticon-5x fonticon-' + name;
					...
					// const fontIcons = new FontFace('3ds-icons', 'url("../style/3ds_fonticon_v2-022.ttf") format("truetype")',);
					// document.fonts.add(fontIcons);
					...
					// 	context.font = '10px 3DS Fonticon';
					// 	context.textAlign = 'center';
					// 	context.fillText(getFontIconChar('internet'), width/2, height/2);
					...
					if (actorCATI3DXUIEvents) {
						...
						this.listenTo(actorCATI3DXUIEvents, CATI3DXUIEvents.CAT3DXUIEventTypes.CAT3DXUIPressEvent, function() {
							if (! _this._isPressed) {
								...
								// let buttonActor = _this.QueryInterface('CATICXP3DUIActor');
								// if (buttonActor) {
								// 	buttonActor.doUIDispatchEvent('UIPressEvent');
								// }
							}
						});
						this.listenTo(actorCATI3DXUIEvents, CATI3DXUIEvents.CAT3DXUIEventTypes.CAT3DXUIReleaseEvent, function() {
							...
							if (_this._isHovered) {
								...
								// let buttonActor = _this.QueryInterface('CATICXP3DUIActor');
								// if (buttonActor) {
								// 	buttonActor.doUIDispatchEvent('UIReleaseEvent');
								// }
							}
						});
						this.listenTo(actorCATI3DXUIEvents, CATI3DXUIEvents.CAT3DXUIEventTypes.CAT3DXUIEnterEvent, function() {
							if (! _this._isHovered) {
								...
								// let buttonActor = _this.QueryInterface('CATICXP3DUIActor');
								// if (buttonActor) {
								// 	buttonActor.doUIDispatchEvent('UIEnterEvent');
								// }
							}
						});
						this.listenTo(actorCATI3DXUIEvents, CATI3DXUIEvents.CAT3DXUIEventTypes.CAT3DXUIExitEvent, function() {
							if (_this._isHovered) {
								...
								// let buttonActor = _this.QueryInterface('CATICXP3DUIActor');
								// if (buttonActor) {
								// 	buttonActor.doUIDispatchEvent('UIExitEvent');
								// }
							}
						});
