...
define('DS/Foundation/WidgetTemplate', ['DS/ENOjquery/ENOjquery'], //prereqs
        function (jQuery) {
    'use strict';
    var WidgetTemplate = {
        generic: function () {
...
define('DS/Foundation/FoundationData', [
        'UWA/Core', 'UWA/Array', 'UWA/Data', 'UWA/Storage', 'DS/ENOjquery/ENOjquery', 'DS/Foundation/FoundationAjax'
    ],
...
define('DS/Foundation/WidgetAPIs', ['UWA/Core', 'DS/ENOjquery/ENOjquery',
            ...
            getCollaborativeSpaces: function(callbackFunction, options) { //returns a list of cspaces.
                ...
                var getCSpacesDone = function(lOptions, data) {
                    ...
                    if (!cspaces || cspaces.length === 0) {
                        ...
                        cspaces = [];
                        if(typeof widget !== 'undefined' && widget.getValue('createSampleData')){
 ...
 */
/*global define*/
define("DS/Foundation/WidgetSave", ["DS/Foundation/WidgetAPIs", 'DS/ENOjquery/ENOjquery', 'DS/Foundation/FoundationData'], function(WidgetAPIs, jQuery, FoundationData) {
    'use strict';
    var WidgetSave = {
...
/* global WidgetConstants */
/* global WidgetEngine */
define('DS/Foundation/WidgetPreferences', ['DS/Foundation/WidgetAPIs', 'DS/ENOjquery/ENOjquery'], function(WidgetAPIs, jQuery) {
    "use strict";
...
/*global enoviaServer*/
define(
    'DS/Foundation/WidgetTagNavInit', ['DS/E6WCommonUI/WidgetUtils', 'DS/ENOjquery/ENOjquery', 'DS/Foundation/FoundationData', 'DS/Foundation/WidgetAPIs'],
...
define('DS/Foundation/WidgetUwaUtils', ['UWA/Core', 'DS/ENOjquery/ENOjquery', 'UWA/Utils/Client', //too long
    ...
    function(UWA, jQuery, UWAUtilsClient, WidgetAPIs, WidgetEngine, FoundationData,
        ...
        var WidgetUwaUtils = {
            ...
            getDefaultContextValue: function() {
                ...
                if (typeof enoviaServer !== 'undefined') {
                    return enoviaServer && enoviaServer.space;
                }
                return;
            },
            /**
