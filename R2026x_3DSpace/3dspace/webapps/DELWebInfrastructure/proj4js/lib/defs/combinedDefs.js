//The ones below are used by FOE app
Proj4js.defs["EPSG:3395"] = "+proj=merc +lon_0=0 +k=1 +x_0=0 +y_0=0 +datum=WGS84 +units=m +no_defs ";
Proj4js.defs["EPSG:6893"] = "+proj=tmerc +lat_0=0 +lon_0=-84 +k=0.9999 +x_0=304800 +y_0=0 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs ";
Proj4js.defs["EPSG:4326"] = "+proj=longlat +datum=WGS84 +no_defs";
//The ones below automtically came with the library, but may not actually be used anywhere
