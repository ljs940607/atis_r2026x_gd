...
function handleDeviceOrientationChange ( event ) {
	...
	for ( var i in sensors.orientation.callbacks ) {
        ...
        //was throwing errors if did not catch these two.
        if(i!= "detect" && i!="invoke"){
...
FULLTILT.getDeviceOrientation = function(options) {
	...
	var promise = new Promise(function(resolve, reject) {
		...
		//}).catch(function() { //NWT 7/13/2015 - use the "then(undefined,function() {" version above as that doesn't cause problems with the build script/closure
