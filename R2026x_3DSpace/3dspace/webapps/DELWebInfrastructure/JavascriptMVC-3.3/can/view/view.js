steal("can/util", function( can ) {
	...
	if ( window.steal ) {
		steal.type("view js", function( options, success, error ) {
			 ...
			 * })
			 */
			//nwt 1/17/2019 - added the window.can to this for when we steal an EJS after loading the entire app dynamically
			options.text = "steal('" + (type.plugin || "can/view/" + options.type) + "',function(can){can=(can.view?can:(window.can||can));return " + "can.view.preload('" + id + "'," + options.text + ");\n})";
			success();
		})
	}
