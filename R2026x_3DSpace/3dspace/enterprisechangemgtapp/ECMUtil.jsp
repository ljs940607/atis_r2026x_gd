...
<jsp:useBean id="uxChangeAction" class="com.dassault_systemes.enovia.enterprisechangemgtapp.common.ChangeAction" scope="session"/>
    ...
    try     
    {
            ...
            else if ("resumeChange".equalsIgnoreCase(functionality) || "resumeChangeAction".equalsIgnoreCase(functionality) || "resumeChangeforCR".equalsIgnoreCase(functionality)) 
            {
                if("resumeChange".equalsIgnoreCase(functionality)){
                    ...
                    //uxChangeRequest.resumeCR(context);
                	uxChangeRequest.setId(objectId);
                ...
                <%
                if(!ChangeUXUtil.isNullOrEmpty(targetFrame)) 
                {
                %>  
            ...
            {
                uxChangeOrder.setId(objectId);
                uxChangeOrder.transferBackToInitiator(context);
            }
...
//getTopWindow().location.href = "../common/emxCloseWindow.jsp";						
			...
			*/
            //Promote & Demote Change Template Object  
                        ...
                        if(sFinalSet.size()>1){%>
                         ...
                         <%}
                            ...
                            try{
                                String alrtMsg = com.dassault_systemes.enovia.enterprisechangemgt.common.ChangeTemplate.promote(context, mlState);
                    ...
                    boolean isSuccess = ChangeTemplate.isChange(context, slObjectIds);
                    ...
                    boolean isSuccess = ChangeTemplate.isChangeAction(context, slObjectIds);
                    StringBuffer sb = new StringBuffer();
                    ...
                    String isMassApproval = emxGetParameter(request,"MassApproval");
                    String action = action = "../common/emxTableEdit.jsp?program=enoECMChangeOrderUX:getChangeTasks&objectIdToApprove="+sb.toString()+"&table=AEFMyTaskMassApprovalSummary&selection=multiple&header=emxComponents.Common.TaskMassApproval&postProcessURL=emxLifecycleTasksMassApprovalProcess.jsp&HelpMarker=emxhelpmytaskmassapprove&suiteKey=Components&StringResourceFileId=emxComponentsStringResource&SuiteDirectory=component";
                    if(isSuccess)
                    {%>
                    <body>
                        <form name=TaskMassApproveForm id=TaskMassApproveForm method="post">
                           ...
                           // getTopWindow().closeWindow();
                            ...
                            if(!UIUtil.isNullOrEmpty(sInValidObject)){
                                ...
                                while(objItr.hasNext()){
                                    ...
                                    uxChangeOrder.setId(id);
                                    String sOriginator = uxChangeOrder.getInfo(context, DomainConstants.SELECT_ORIGINATOR);
                    ...
                    //Delete CO, selection multiple COs 
                        ...
                        if(!isSuccess){
                            ...
                            while(itrObj.hasNext()){
                                ...
                                uxChangeOrder.setId(id);
                                Map mInfoMap = uxChangeOrder.getInfo(context, slCOSelectable);
                                ...
                                {
                                	sAccessCheck = uxChangeOrder.getAccessMask(context).hasDeleteAccess();
                                	if(sAccessCheck)
                					{
                                		uxChangeOrder.deleteObject(context);
                					}
                                	else
                                	{	
                                		%>
                    ...
                    //Delete Change Template  
                        ...
                        try{
                                String sAlertMsg = com.dassault_systemes.enovia.enterprisechangemgt.common.ChangeTemplate.delete(context, slObjectIds); 
            ...
            //Add Attributes to Change Template Object Interface
                        ...
                        try{
                        boolean isSuccess = com.dassault_systemes.enovia.enterprisechangemgt.common.ChangeTemplate.addAttributeGroupToChangeTemplate(context, slObjectIds, parentOID);
                        if(isSuccess){%>
                            <script language="javascript">
                                getTopWindow().getWindowOpener().location.href=getTopWindow().getWindowOpener().location.href;
                                getTopWindow().closeWindow();
                        ...
                        try{
                        boolean isSuccess = com.dassault_systemes.enovia.enterprisechangemgt.common.ChangeTemplate.removeAttributeGroupFromChangeTemplate(context, slObjectIds, parentOID);
                        if(isSuccess){%>
                            <script language="javascript">
                        ...
                        try{
                        boolean isSuccess = com.dassault_systemes.enovia.enterprisechangemgt.common.ChangeTemplate.AddRemoveAttributesToAttributeGroup(context, slObjectIds, AGName, "add");
                        ...
                        String AGName = emxGetParameter(request,"AGName");
                        try{
                        boolean isSuccess = com.dassault_systemes.enovia.enterprisechangemgt.common.ChangeTemplate.AddRemoveAttributesToAttributeGroup(context, slObjectIds, AGName, "remove");
                        if(isSuccess){%>
                            <script language="javascript">
                                getTopWindow().refreshTablePage();
                            </script>
...
/*			 
           ...
           // Move As Affected Item
            ...
            {     
                ...
                if(!ChangeUXUtil.isNullOrEmpty(strInvalidObjectts)){
            ...
            if("delete".equalsIgnoreCase(strMode))
             {
              ...
              else if("AddExistingIA".equalsIgnoreCase(strMode)) 
              {
                ...
                <%
						...
						if (targetTag.equalsIgnoreCase("select")) {
							...
							if (emxTableRowIds!=null && emxTableRowIds.length>0) {
								...
								<script language="javascript" type="text/javaScript">
									...
									if(!targetLocation || getTopWindow().location.href.indexOf("emxNavigator") === -1){
					...
					%>
					<script language="javascript" type="text/javaScript">
						if(top.location.href.indexOf("targetLocation=popup") > -1 && top.location.href.indexOf("emxNavigator") === -1){
					...
					%>
					<script language="javascript" type="text/javaScript">
						if(top.location.href.indexOf("targetLocation=popup") > -1 && window.getTopWindow().location.href.indexOf("emxNavigator") === -1){
                            window.getTopWindow().closeWindow();
                        }
					</script>
					<%
              ...
              //ECM Related CA
            	  ...
            	  isEditable=ChangeUXUtil.hasLicenseOfECM(context);                     
...
<%
	//if("validateRequestedChange".equalsIgnoreCase(functionality)){
	  ...
	  //String alrtMsg = uxChangeAction.checkIfRequestedChangeValid(context, changeId, affectedItemId, //requestedChangeValue, strContext);
