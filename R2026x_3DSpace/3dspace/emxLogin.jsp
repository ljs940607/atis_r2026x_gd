...
if (Framework.isLoggedIn(request))
{
    ...
    //JPA-
    // Added to handle History page loaded from Dashboard in Edit Prop Widget Facet //
    String historyReferer = request.getHeader("referer");
    if(historyReferer != null && historyReferer.indexOf("historyFacet=true") >= 0){
        session.setAttribute("HISTORY_REFERER", historyReferer);
    }
