...
if(UIUtil.isNullOrEmpty(reLoad)){
	...
	if(rowIds != null){
		...
		objType = new DomainObject(rowIds[i-1]).getType(context).toString();
	}
		...
		if("Artwork Template".equals(objType)){
			url += "&HelpMarker=emxhelpartworktemplates&suiteKey=AWL";
		}else{
			url += "&HelpMarker=emxhelpartworkelements&suiteKey=AWL";
		}
%>
