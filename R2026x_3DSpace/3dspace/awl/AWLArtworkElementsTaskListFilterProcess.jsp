...
<%
	String requestParameters = AWLUIUtil.getRequestParametersQueryString(context, request, true, 
		"AWLArtworkElementsTaskManagementFilterCommand");
...
<script language="Javascript">
    var filterCmd = getTopWindow().document.getElementById('AWLArtworkElementsTaskManagementFilterCommand');
    filterCmd = filterCmd == null ? window.parent.document.getElementById('AWLArtworkElementsTaskManagementFilterCommand') : filterCmd;
    var taskFilter = filterCmd != null ? filterCmd.value : "";
    //XSSOK url : Request Param, taken care in AWLUIUtil.getRequestParametersQueryString
    window.parent.frames.location.href  = "<%=url%>" + "&AWLArtworkElementsTaskManagementFilterCommand=" + taskFilter;
</script>
