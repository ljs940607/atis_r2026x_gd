...
<%
	...
	if("affectedItems".equalsIgnoreCase(functionality)) {
	  ...
	  //XSSOK
	    ...
	    //XSSOK
	    searchURL+="&addPreCondParam=false&viewFormBased=true&table=AEFGeneralSearchResults&selection=multiple&showSavedQuery=True&searchCollectionEnabled=True&excludeOIDprogram=emxCommonIssue:excludeIssueResolvedItem&srcDestRelName=relationship_ResolvedTo&isTo=false&submitURL=../components/emxEngineeringChangeUtil.jsp?mode=AddExistingECSatisfiedItems";
        }
        else{
	  //XSSOK
