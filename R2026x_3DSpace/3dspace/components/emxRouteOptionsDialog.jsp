...
<input type="hidden" name="portalMode" value="<xss:encodeForHTMLAttribute><%=portalMode%></xss:encodeForHTMLAttribute>" />
  ...
  <table border="0" cellpadding="5" cellspacing="2" width="100%">
    ...
    <tr>
      ...
      <td width="380" class="inputField"><emxUtil:lzDate displaydate="true" displaytime="true" localize="i18nId" tz='<%=(String)session.getAttribute("timeZone")%>' format='<%=DateFrm %>' ><%=sOriginated%></emxUtil:lzDate>&nbsp;</td>
    </tr>
