...
%>
      <td colspan="1" class="inputField">
      	<!--//XSSOK-->
      	<input type="text" name="<%=XSSUtil.encodeForHTMLAttribute(context,	(String) sAttrName)%>" value="<emxUtil:lzDate displaydate="true" displaytime="true" localize="i18nId" tz='<%=(String)session.getAttribute("timeZone")%>' format='<%=DateFrm%>'><%=sDefaultValue%></emxUtil:lzDate>" readonly="readonly" />&nbsp;&nbsp;
