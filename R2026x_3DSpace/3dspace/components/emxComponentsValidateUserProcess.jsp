...
<%
    ...
    {
        session.setAttribute("error.message",ComponentsUtil.i18nStringNow("emxComponents.UserAuthentication.Error",request.getHeader("Accept-Language")));
        session.setAttribute("VerificationCount",new Integer(++ count).toString());
%>
