...
<%
  ...
  try
  {
      ...
      {
          session.setAttribute("error.message", ComponentsUtil.i18nStringNow("emxComponents.ViewerLaunch.NullValues", languageStr));
  ...
  catch(Exception Ex)
  {
        ...
        session.setAttribute("error.message", ComponentsUtil.i18nStringNow("emxComponents.ViewerLaunch.NoViewerFound", languageStr));
%>
