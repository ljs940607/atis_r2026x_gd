...
try
{
  ...
  if ( "disconnect".equals(action) )
  {
      ...
      {
    	String removeContentId = PropertyUtil.getGlobalRPEValue(context, "MX_CONTENT_DELETE_BLOCK_NOTIF_SENT");
    	PropertyUtil.unsetGlobalRPEValue(context, "MX_CONTENT_DELETE_BLOCK_NOTIF_SENT");
    	boolean isContentRemoved = false;
    	if(UIUtil.isNotNullAndNotEmpty(removeContentId)){
    		isContentRemoved = Arrays.asList(oids).contains(removeContentId);
    	}    	  
