...
<%
    if(!showLabel && !isOwner)
    {
        if(UIUtil.isNullOrEmpty(templateId) || (strTaskEditSetting.equals("Modify/Delete Task List") || strTaskEditSetting.equals("Modify Task List"))){		
        	String sAccessMask = com.matrixone.apps.domain.DomainAccess.getLogicalNameForPolicy(context, "Route", sAccess);
        	if(sAccessMask.equals("Read")) {
              sReadSelected="selected";
            } else if(sAccessMask.equals("Read Write")) {
              sReadWriteSelected="selected";
            } else if(sAccessMask.equals("Add")) {
              sAddSelected="selected";
            } else if(sAccessMask.equals("Remove")) {
              sRemoveSelected="selected";
            } else if (sAccessMask.equals("Add Remove")) {
