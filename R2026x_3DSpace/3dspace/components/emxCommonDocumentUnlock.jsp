    ...
    try
    {
      ...
      if("true".equalsIgnoreCase(vcfileStr)) {
          ...
          for (int i=0; i<oids.length; i++ )
          {
		    ...
		    Document parentObj = (Document)DomainObject.newInstance(context, DomainConstants.TYPE_DOCUMENT);
  		    parentObj.setId(ObjId);
  		    String unlockAccess = parentObj.getInfo(context, "current.access[unlock]");			
			...
			if(context.getUser().equals(ObjLocker) || unlockAccess.equals("TRUE"))
