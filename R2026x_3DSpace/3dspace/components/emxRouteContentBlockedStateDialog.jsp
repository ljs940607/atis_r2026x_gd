...
<%
    ...
    selListRel.add("to.attribute[Route Status]");
...
<%
   ...
   sRouteStatus = (String) routableObjsMap.get("to.attribute[Route Status]");
...
%>
    <tr class='<framework:swap id ="1" />'>
      ...
      <td>
        ...
        %>
		<!-- //XSSOK -->
      <%=populateCombo(context, session, sStates, isAutoPromote, (String)routableObjsMap.get(routeObject.SELECT_ID), (String)routableObjsMap.get(routeObject.SELECT_RELATIONSHIP_ID), (String)routableObjsMap.get(routeObject.SELECT_OWNER), sCurState, sPolicy,sType, isIRPCContent, sRouteBaseState, sNoneValue, languageStr,sRouteStatus)%>
      </td>
    </tr>
...
<%!
    static public String populateCombo(matrix.db.Context context, HttpSession session,String sStates,boolean isAutoPromote, String routableObjId, String sRelationID, String routeOwner, String curState, String sPolicy, String sType, String isIRPCContent,String sStateValue, String sNoneValue,String sLangStr, String sRouteStatus) {
      String sReturn    = "";
      ...
      try {
        ...
        boolean isRouteStarted = "Started".equals(sRouteStatus);
            ...
            while(sTok.hasMoreTokens()) {
              ...
              if(sPropName.equalsIgnoreCase(Statename)){
                  ...
                  sReturn += "<option value=\""+sSymbolicPolicyName+"#"+ XSSUtil.encodeForHTMLAttribute(context,sSymbolicStateName)+"\" selected >" + Statename +"</option>";//EnoviaResourceBundle.getProperty(context, "emxFrameworkStringResource", context.getLocale(), sPropName) ;
	                   } else if (!isRouteStarted || curState.equals(sStateName)){
