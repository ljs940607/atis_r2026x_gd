...
<%
  ...
  Map routeInfo = route.getInfo(context, selects);
  String sOwner       = (String)routeInfo.get(route.SELECT_OWNER);
  String sState = (String)routeInfo.get(route.SELECT_CURRENT);
