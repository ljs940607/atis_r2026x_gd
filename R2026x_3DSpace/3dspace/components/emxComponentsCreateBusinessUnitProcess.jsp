...
<%
  ...
  //End:01-June-2010:s4e:R210 PRG:AdvanceResourcePlanning
    ...
    else 
    {
      ...
      if(nameExists) {
          session.setAttribute("error.message", ComponentsUtil.i18nStringNow("emxComponents.BusinessUnit.BusinessAlreadyExists", strLanguage));
      }else if(idExists) {
          session.setAttribute("error.message", ComponentsUtil.i18nStringNow("emxComponents.CreateOrEditOrganization.OrganizationIdAlreadyExists", strLanguage));
      }else if(cageCodeExists) {
          session.setAttribute("error.message", ComponentsUtil.i18nStringNow("emxComponents.CreateOrEditCompany.CageCodeAlreadyExists", strLanguage));
      }
    }
