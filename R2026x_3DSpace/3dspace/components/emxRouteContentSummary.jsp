...
<%
  ...
  selListObj.add(DomainConstants.SELECT_KINDOF_PLMENTITY);
...
<%
   ...
   plmCoreRepReference = 	(String)routableObjsMap.get(DomainConstants.SELECT_KINDOF_PLMENTITY);
   ...
   if (!"Ad Hoc".equals(stateValue) && com.matrixone.apps.common.Route.isStateBlockingAllowed(context,sType) && !"true".equalsIgnoreCase(plmCoreRepReference)){
