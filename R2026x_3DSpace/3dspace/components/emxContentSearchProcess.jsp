...
<%
Map<String, String> respone = com.dassault_systemes.enovia.route.modeler.RouteModeler.getChangeControlledObject(context,docs);
boolean isChangeControlled = false;
