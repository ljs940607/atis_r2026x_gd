...
%>
      ...
      <!-- //XSSOK -->
      <td><emxUtil:lzDate localize="i18nId" tz='<%=(String)session.getAttribute("timeZone")%>' format='<%=XSSUtil.encodeForHTML(context, DateFrm) %>'><%=XSSUtil.encodeForHTML(context, sDueDate)%></emxUtil:lzDate>&nbsp;</td>
    </tr>
<%
  }
              ...
              String scheduledDateVal ="";
                ...
                time = new Long(dtObj.getTime());
                 scheduledDateVal =routeScheduledCompletionDateValueStr;
                  int iTimeZone = (new Double((new Double((String)session.getAttribute("timeZone"))).doubleValue() * -3600000)).intValue(); //60*60*1000 *-1;
