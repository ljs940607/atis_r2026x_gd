...
%>
   ...
   getTopWindow().closeSlideInDialog();
	  ...
	  var url = detailsDisplayFrame.location.href;
	  var replaceURL=url.replace("persist=true", "");
      detailsDisplayFrame.location.href = replaceURL;
      }else if(listDisplayFrame){
	   var url = listDisplayFrame.location.href;
	   var replaceURL=url.replace("persist=true", "");
       listDisplayFrame.location.href = replaceURL;
      }
    </script>
