    ...
    try
    {
        if (projectId != null && !"null".equals(projectId) && !"".equals(projectId))
        {
           ...
           /*  } else {
               ...
               session.setAttribute("error.message", typeTranslatedName + " " + projectName + " " + i18nNow.getI18nString("emxTeamCentral.Common.AlreadyExists","emxTeamCentralStringResource",sLanguage));
            } */
        }
