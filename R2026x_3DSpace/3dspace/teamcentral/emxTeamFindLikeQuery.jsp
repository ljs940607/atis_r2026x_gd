...
%>
        ...
        <!-- //XSSOK -->
		<td><emxUtil:lzDate localize="i18nId" tz='<%=XSSUtil.encodeForHTML(context, (String)session.getAttribute("timeZone"))%>' format='<%=DateFrm %>' ><%= (XSSUtil.encodeForHTML(context,map.get(rts.SELECT_ORIGINATED).toString())) %></emxUtil:lzDate></td>
        </tr>
    </framework:mapListItr>
  </table>
...
%>
        ...
        <td>
          <emxUtil:lzDate localize="i18nId" tz='<%=XSSUtil.encodeForHTMLAttribute(context, (String)session.getAttribute("timeZone"))%>' format='<%=DateFrm %>' ><%= XSSUtil.encodeForHTML(context,map.get(person.SELECT_ORIGINATED).toString()) %></emxUtil:lzDate>
          &nbsp;
        </td>
        <td><!-- //XSSOK -->
          <emxUtil:lzDate localize="i18nId" tz='<%=XSSUtil.encodeForHTMLAttribute(context, (String)session.getAttribute("timeZone"))%>' format='<%=DateFrm %>' ><%= map.get(clsRTQ.getField("SELECT_ACTUAL_COMPLETION").get(objRtq)) %></emxUtil:lzDate>
          &nbsp;
        </td>
