...
%>
  ...
  <tr class='<framework:swap id ="1" />'>
	...
	<td><img src="images/iconSmallFolder_new.png" name="imgFolder" id="imgFolder" alt="<%=XSSUtil.encodeForHTMLAttribute(context,templateMap.get(folderObj.SELECT_ATTRIBUTE_TITLE).toString())%>" /><a href="<%=XSSUtil.encodeForHTMLAttribute(context,templateMap.get(folderObj.SELECT_ATTRIBUTE_TITLE).toString())%>"></a> <%=XSSUtil.encodeForHTMLAttribute(context,templateMap.get(folderObj.SELECT_ATTRIBUTE_TITLE).toString())%></td>
    <!-- //XSSOK -->
