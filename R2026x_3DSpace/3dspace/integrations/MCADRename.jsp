...
%>
        ...
        if('<%=bEnableAppletFreeUI%>' == "true")
        	{
        	var renameDetails = "integrationName="+'<%=integrationName%>' + "&isAutoName=" + isAutoName + "&seriesName="+ seriesName+"&busId="+ busId+"&newName="+encodeURI(newName)+"&instanceName="+instanceName;
