...
if(typeAhead == "true") 
{
    ...
    targetWindow = getTopWindow().SnN.FRAME_TO_BE_REFRESHED;
...
{
%>		
		getTopWindow().SnN.FRAME_TO_BE_REFRESHED.<%=XSSUtil.encodeForJavaScript(context,methodName)%>(vfieldNameActual.value);
